...
import { Lock, User, ChevronDown, Sun, Moon, ShieldCheck, Activity } from 'lucide-react';
    ...
    <div className="login-page">
      ...
      <div className="login-card">
        <div className="login-header">
          ...
          <h1 className="login-title">云枢 LLMOps</h1>
          <p className="login-desc">AI 应用运营操作系统 · 可观测性 · 评测 · 成本</p>
        </div>

        <div className="sso-badge">
          <ShieldCheck size={11} />
          <span>通过企业 SSO 统一身份认证登录</span>
        </div>
        ...
        <div className="login-foot">
          <span className="row gap-1"><Activity size={11} /> 312 QPS</span>
          <span className="mononum">p95 1,840ms</span>
          <span className="mononum">5 应用接入</span>
        </div>
      </div>
    </div>
  );
