...
import { Lock, User, ChevronDown, Sun, Moon, Workflow } from 'lucide-react';
    ...
    <div className="login-page">
      ...
      <div className="login-card">
        <div className="login-header">
          <div className="login-logo">织</div>
          <h1 className="login-title">织流 · Agent 编排平台</h1>
          <p className="login-desc">把多 LLM / 工具 / Agent 编排成可执行、可监控的工作流 —— 对标 LangGraph / Dify / Coze</p>
        </div>

        <div className="sso-badge">
          <Workflow size={11} />
          <span>可执行可监控的 Agent 编排 · 高风险节点保留 human-in-loop 卡点</span>
        </div>
