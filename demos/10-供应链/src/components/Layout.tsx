      ...
      <aside className="sidebar">
        <button className="sidebar-logo" onClick={() => navigate(firstAllowedPath(hasPermission))}>
          ...
          <div style={{ textAlign: 'left' }}>
            <div className="logo-title">链枢 · 供应链中台</div>
            <div className="logo-sub">预测 · 库存 · 补货 · 履约</div>
          </div>
        </button>
      ...
      <div className="main">
        <header className="topbar">
          ...
          <button className="global-search" onClick={() => setPalette(true)}>
            <Search size={16} />
            <span className="global-search-ph">搜 SKU / 仓 / 门店 / 供应商 · 或执行快捷操作</span>
            <span className="kbd">⌘K</span>
          </button>

          <div className="row gap-2" style={{ marginLeft: 'auto', position: 'relative' }}>
            <div className="row gap-1 svc-pill" title="Agent 自主补货/调拨 · 高金额/高风险决策保留人审卡点">
              <ShieldCheck size={13} /><span>Agent 自主 · 关键卡点人审</span>
            </div>
