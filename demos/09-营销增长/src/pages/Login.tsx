...
import { Lock, User, ChevronDown, Sun, Moon, Sparkles } from 'lucide-react';
    ...
    <div className="login-page">
      ...
      <div className="login-card">
        <div className="login-header">
          <div className="login-logo">增</div>
          <h1 className="login-title">增势 · 营销增长中台</h1>
          <p className="login-desc">洞察 → 多模态创意 → 多渠道投放 → AI 归因优化 —— 对标 Adobe GenStudio / Braze</p>
        </div>

        <div className="sso-badge">
          <Sparkles size={11} />
          <span>全链路 Agent 提效 · 关键决策保留人审卡点（合规 / 预算 / 授权）</span>
        </div>
