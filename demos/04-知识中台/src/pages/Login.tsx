    ...
    <div className="login-page">
      ...
      <div className="login-card">
        <div className="login-header">
          ...
          <h1 className="login-title">智库 · 企业知识中台</h1>
          <p className="login-desc">权限感知 · 可溯源 · 对标 Glean 的可信知识层</p>
        </div>

        <div className="sso-badge">
          <ShieldCheck size={11} />
          <span>企业 SSO 登录 · 检索结果按你的权限密级严格过滤</span>
        </div>
        ...
        <div className="quick">
          <button className="quick-toggle" onClick={() => setShowQuick(s => !s)}>
            <span>演示账号快速登录（体验 4 角色 × 权限感知）</span>
