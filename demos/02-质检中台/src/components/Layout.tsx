    ...
    <div className={`app-shell ${mobileNav ? 'nav-open' : ''}`}>
      ...
      <aside className="sidebar">
        <div className="sidebar-logo">
          ...
          <div>
            <div className="logo-title">AI 质检中台</div>
            <div className="logo-sub">100% 全量质检 · v2</div>
          </div>
        </div>
      ...
      <div className="main">
        <header className="topbar">
          ...
          <div className="row gap-2" style={{ marginLeft: 'auto', position: 'relative' }}>
            <div className="row gap-1 svc-pill" title="全量质检 · 100% 覆盖 · 双录留痕">
              <ShieldCheck size={13} /><span>全量质检 · 100% 覆盖</span>
            </div>
        ...
        <div className="content">
          <div className="content-anim" key={location.pathname}>
            {denied
              ? <div className="page"><EmptyState icon={<Lock size={36} />} title="无访问权限" desc="当前角色无权访问此模块，如需开通请联系质检主管或合规官" /></div>
              : <Outlet />}
          </div>
        </div>
      </div>
