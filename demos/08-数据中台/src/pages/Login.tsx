    ...
    <div className="login-page">
      ...
      <div className="login-card">
        <div className="login-header">
          <div className="login-logo">演</div>
          <h1 className="login-title">演算台 · 数据中台</h1>
          <p className="login-desc">NL 问数 · 语义层确定性查询 · 可信治理 —— 对标 Hex / Cortex Analyst</p>
        </div>

        <div className="sso-badge">
          <ShieldCheck size={11} />
          <span>统一身份认证 · 行列级权限分权 · 答不了报错，绝不返回错数</span>
        </div>
